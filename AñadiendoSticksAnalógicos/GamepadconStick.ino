...
void loop() {
  ...
  */
  //Ejes
  Joystick.setXAxis(analogRead(A0)); //Paso al eje X los valores de la posición del potenciómetro conectado al pin A0
  Joystick.setYAxis(analogRead(A1)); //Paso al eje Y los valores de la posición del potenciómetro conectado al pin A1
}
